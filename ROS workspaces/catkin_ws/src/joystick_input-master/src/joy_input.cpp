...
#define AXIS_XBOX_LEFT_FWD_BACK    3     // Left joystick front to back
#define AXIS_XBOX_LEFT_SIDE_SIDE   2     // Left joystick side to side

// Joystick controls from /joy array for PS3
#define AXIS_PS3__LEFT_FWD_BACK    3
#define AXIS_PS3__LEFT_SIDE_SIDE   2
