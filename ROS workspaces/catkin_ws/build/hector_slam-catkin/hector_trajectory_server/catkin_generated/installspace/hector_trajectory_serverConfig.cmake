...
if("FALSE" STREQUAL "TRUE")
  set(hector_trajectory_server_SOURCE_PREFIX /home/nvidia/catkin_ws/src/hector_slam-catkin/hector_trajectory_server)
  set(hector_trajectory_server_DEVEL_PREFIX /home/nvidia/catkin_ws/devel)
  ...
  set(hector_trajectory_server_INSTALL_PREFIX /home/nvidia/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_trajectory_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/catkin_ws/install/${idir}'.  Ask the maintainer 'Johannes Meyer <meyer@fsr.tu-darmstadt.de>' to fix it.")
    endif()
